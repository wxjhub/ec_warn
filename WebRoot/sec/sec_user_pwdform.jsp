...
<body>
	...
	<div class="table_tt" style="margin-top: 30px;"><span>个人密码修改</span></div>
		<FORM name="formSave" id="formSave" method="post" style="padding: 25px 0 0 25px;height: 315px">
			...
			<div id="myTab1_Content0" >
				<table cellSpacing="0" cellpadding="0" border="0">
					<tr>
						<td width="100px" height="32px">原密码：</td>
						<td width="260px" height="32px">
							<input type="text" class="easyui-validatebox input_eq2" required="true" missingMessage="请输入原密码！" validType="length[6,18]" name="oldPwd"  id="oldPwd"/>
							<span style="color: red;font-size: 15px;"> *</span>
						</td>
					</tr>
					<tr>
						<td width="100px" height="32px">新密码：</td>
						<td width="170px" height="32px">
							<input type="text" class="easyui-validatebox input_eq2" required="true" missingMessage="请输入新密码！" validType="length[6,18]" name="newPwd" id="newPwd"/>
							<span style="color: red;font-size: 15px;"> *</span>
						</td>
					</tr>
					<tr>
						<td width="100px" height="32px">确认新密码：</td>
						<td width="260px" height="32px">
							<input type="password" class="easyui-validatebox input_eq2" required="true" missingMessage="请再次输入新密码!" validType="length[6,18]" name="newPwdBack" id="newPwdBack" />
							<span style="color: red;font-size: 15px;"> *</span>
						</td>
					</tr>
					<tr>
