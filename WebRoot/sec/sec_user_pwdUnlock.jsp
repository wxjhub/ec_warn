...
<body>
	...
	<div class="table_tt" style="margin-top: 30px;"><span>密码解锁</span></div>
		<FORM name="formSave" id="formSave" method="post" style="padding: 25px 0 0 25px;height: 315px">
			<div id="myTab1_Content0" >
				<table cellSpacing="0" cellpadding="0" border="0">
					...
					<tr>
						<td width="100px" height="32px">柜员密码状态：</td>
						<td width="260px" height="32px">
							<input type="password" class="easyui-validatebox input_eq2" name="userFlg" id="userFlg" disabled="disabled"/>
						</td>
					</tr>
					<tr>
