...
(function ($)
{
    ...
    $.ligerDefaults.Filter.operators['string'] = ["equal", "notequal", "startwith", "endwith", "like","greater", "greaterorequal", "less", "lessorequal","in","notin"];
    $.ligerDefaults.Filter.operators['number'] = ["equal", "notequal", "startwith", "endwith", "like","greater", "greaterorequal", "less", "lessorequal","in","notin"];
    $.ligerDefaults.Filter.operators['date'] = ["equal", "notequal", "startwith", "endwith", "like","greater", "greaterorequal", "less", "lessorequal","in","notin"];
    var no=0;
    $.ligerDefaults.Filter.editors['string'] =
    {
        ...
        {
    		no++;
            var input = $("<input type='text' id='"+no+"' onblur='getId(id)' style='width:300px'/>");
    ...
    $.ligerDefaults.Filter.editors['date'] =
    {
        create: function (container, field)
        {
            var input = $("<input type='text' class='datevpf'/>");
            container.append(input);
