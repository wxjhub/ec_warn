...
//					panel += json2str(portal[t].panel('options'))+",";
					panel += "{'title':'" + portal[t].panel('options').title + "',";
					panel += "'uuid':'" + portal[t].panel('options').uuid+ "',";
					panel += "'userId':'" + portal[t].panel('options').userId+ "',";
					panel += "'portalId':'" + portal[t].panel('options').portalId+ "',";
					var content = portal[t].panel('options').content; 
					content=encodeURI(content); 
					panel += "'content':'" + content + "',";
					panel += "'display':" + !portal[t].panel('options').closed+ ",";
					panel += "'rowIndex':" + j + ",";
					panel += "'columnIndex':" + i + ",";
					panel += "'height':" + portal[t].panel('options').height;
					if(j!==colomLength-1) {
						panel += "},";
					} else {
						panel += "}]";
				...
				if("[" == panel.charAt(panel.length-1)) {
					panel += "]";
				} else {
