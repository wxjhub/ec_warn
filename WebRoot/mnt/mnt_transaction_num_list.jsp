...
<%-- 		<INPUT name="pageNo" id="pageNo"type="hidden" value="${param.pageNo}"> 
		...
		<table cellSpacing="0" cellpadding="0" border="0">
			<tr>
				<td height="40px">交易码：<input id="transactionName" type="text"></td>
				<td height="40px">开始时间:</td>
				<td height="40px">
				<input class="easyui-datebox" id="startDate" name="startDate" style="width: 150px; padding: 0px" /></td>
				<td height="40px">结束时间:</td>
				<td height="40px">
				<input class="easyui-datebox" id="endDate" name="endDate" style="width: 150px; padding: 0px" /></td>
			</tr>
			<tr>
				<td colspan="6">
		...
		rownumbers="false" singleSelect="false" editable="true" url="transactionSuccess_statistics.action" 
		striped="true" fit="true" height="50%"  title="交易量展示" id="lrmsMoni">
		<%-- <r:toolbar id="editRow" text="查看交易量" iconCls="icon-edit" onClick="checkListFile();"></r:toolbar>  --%>
			
			<r:col  field="executeDate" title="统计日期" editable="false" sortable="true" width="100" >
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="transactionName" title="交易名称" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="transactionNum" title="交易笔数" editable="false" sortable="true" width="100">
			</r:col>
			
			<r:col  field="successNum" title="交易成功笔数" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="sysSuccessNum" title="系统成功笔数" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="failNum" title="交易失败笔数" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="sysFailNum" title="系统失败笔数" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="transactSuccessRate" title="交易成功率" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="sysSuccessRate" title="系统成功率" editable="false" sortable="true" width="100">
			</r:col>
