...
<%-- 		<INPUT name="pageNo" id="pageNo"type="hidden" value="${param.pageNo}"> 
		...
		striped="true" fit="true" height="50%"  title="交易时长监控" id="lrmsMoni">
			
			<r:col  field="seqNo" title="流水号" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="transactionCode" title="交易码" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="transactionName" title="交易名称" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="codeName" title="响应名称" editable="false" sortable="true" width="150">
			</r:col>
			...
			<r:col  field="normTransactionTime" title="标准处理时间（s）" editable="false" sortable="true" width="100"  >
			</r:col>
