...
<body>
	...
	<div class="gridDiv">
		<r:grid sortable="true" remoteSort="true" pagination="true"
			...
			url="transactionTimeConfig_findTransactionTimeList.action"
			striped="true" fit="true" height="100%" title="交易时长配置" id="lrmsMoni">
			...
			<r:col field="countCycle" title="统计周期（秒）" sortable="true" width="100" editable="true">
				<r:editorText></r:editorText>
			</r:col>
			<r:col field="transactionTime" title="单笔交易标准处理时长（秒）" sortable="true" width="130" editable="true">
				<r:editorText></r:editorText>
			</r:col>
			<r:col field="transactionTimeValueY" title="超时交易笔数预警阀值" sortable="true" width="130" editable="true">
				<r:editorText></r:editorText>
			</r:col>
			<r:col field="transactionTimeValueG" title="超时交易笔数告警阀值" sortable="true" width="130" editable="true">
				<r:editorText></r:editorText>
			</r:col>
	...
	function save() {
		...
		if (vali) {
			...
			if (selected.length > 1) {
				...
				var transactionTimeValueY = selected[0].transactionTimeValueY;
				var transactionTimeValueG = selected[0].transactionTimeValueG;
				...
				$.ajax({
							...
							data : {
								...
								transactionTimeValueY : transactionTimeValueY,
								transactionTimeValueG : transactionTimeValueG,
								warningLevl : warningLevl,
								col1 : col1,
								col2 : col2,
								col3 : col3
							},
							url : "transactionTimeConfig_save.action",
							error : function(data) {
								...
								if (selected.length == 0) {
									...
									$
											.ajax({
												...
												type : 'post',
												dataType : "Json",
												url : "${pageContext.request.contextPath}/transactionTimeConfig_remove.action?uuid="
														+ uuids,
												success : function(data) {
													$.messager.alert('系统提示',
															'删除成功', 'warning');
