...
function findService(){
	...
	$.ajax({
		...
		data:selected[0],
		dataType : "Json",
		url: "${pageContext.request.contextPath}/externalNetwork_serviceServer.action",
...
<body class="easyui-layout" border="false" onload="page_top()">
	<div region="west" style="width:780px;border-left: none;" border="true" title="网络监控">
		...
		rownumbers="false" singleSelect="true" editable="true" url="externalNetWorkConfig_findNetWorkList.action" 
		striped="true" fit="true" height="100%"  title="对端网络监控" id="lrmsMoni" >
...
<%-- 			<r:editorText missingMessage="不能为空" required="true"></r:editorText> --%>
			...
			<r:col  field="oppositeHostName" title="对端主机名称" sortable="true" width="150" editable="false">
<%-- 			<r:editorText  missingMessage="不能为空" required="true"></r:editorText> --%>
			</r:col>
			<r:col  field="oppositeHostIP" title="对端IP" sortable="true" width="150" editable="false">
<%-- 			<r:editorText  missingMessage="不能为空" required="true"></r:editorText> --%>
			</r:col>
			<r:col  field="oppositeHostPort" title="端口" sortable="true" width="150" editable="false">
<%-- 			<r:editorText  missingMessage="不能为空" required="true"></r:editorText> --%>
			</r:col>
