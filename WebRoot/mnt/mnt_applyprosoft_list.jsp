...
<body>
	<form name="formSearch" id="formSearch" method="post" style="padding: 20px 0 20px 30px;">
		...
		<table cellSpacing="0" cellpadding="0" border="0">
			<tr>
				<td height="40px">主机名：<input id="hostName" type="text"></td>
				<td>
		...
		rownumbers="false" singleSelect="false" editable="true" url="applyprosoft_findApplyProSoftList.action" 
		striped="true" fit="true" height="100%"  title="应用程序监控" id="lrmsMoni">
...
<%-- 			<r:col  field="uuid" title="ID"  checkbox="true"   sortable="true" width="260" editable="false" >
			...
			<r:col  field="hostName" title="主机名" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="localIp" title="服务器IP" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="serverName" title="服务名" editable="false" sortable="true" width="150" >
			<r:editorText></r:editorText>
			</r:col>
			<%-- <r:col  field="courseCode" title="进程代码" editable="false" sortable="true" width="150" >
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="courseMeaning" title="进程含义" sortable="true" width="100" editable="false">
			<r:editorText></r:editorText>
			</r:col> --%>
			<r:col  field="maxCourseNum" title="服务数" sortable="true" width="100" editable="false">
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="warningLevl" title="预警级别" sortable="true" editable="false" width="100" dictId="ec.warnLvl">
			<r:editorDictSelect></r:editorDictSelect>
			</r:col>
			<r:col  field="remark" title="备注" sortable="true" width="100" editable="false">
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="courseNum" title="当前服务数" sortable="true" width="100" editable="false"  >
			<r:editorText></r:editorText>
			</r:col>
			<r:col field="collectDate" title="采集时间" sortable="true"
				width="130" hasTime="true" dateFormat="yyyy-MM-dd" editable="false">
			</r:col>
			<r:col  field="courseStatus" title="服务状态"  editable="false" sortable="true" width="100" formatter="courseStatustype(value, rowData, rowIndex)" >
			<r:editorText></r:editorText>
			</r:col>
