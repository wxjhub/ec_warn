...
<%-- 		<INPUT name="pageNo" id="pageNo"type="hidden" value="${param.pageNo}"> 
		...
		<table cellSpacing="0" cellpadding="0" border="0">
			<tr>
				<td height="40px">表名：<input id="tableName" type="text"></td>
		...
		rownumbers="false" singleSelect="false" editable="true" url="tableAnalysis_findList.action" 
		striped="true" fit="true" height="50%"  title="表分析监控" id="lrmsMoni">
			
			<r:col field="tablespaceName" title="表空间" sortable="true" width="150" editable="false">
			</r:col>
			<r:col  field="tableName" title="表名" editable="false" sortable="true" width="250">
			</r:col>
			<r:col  field="lastAnalyzed" title="最后一次表分析时间" sortable="true" width="150" editable="false">
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="sampleSize" title="表空间数据量大小" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="tableSize" title="表数据量大小" editable="false" sortable="true" width="100">
			</r:col>
			<r:col  field="deviation" title="数据量偏差" editable="false" sortable="true" width="100">
			</r:col>
