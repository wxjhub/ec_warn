...
<body>
	<form name="formSearch" id="formSearch" method="post" style="padding: 20px 0 20px 30px;">
		...
		rownumbers="false" singleSelect="false" editable="true" url="applyprosoftConfig_findApplyProSoftList.action" 
		striped="true" fit="true" height="100%"  title="应用服务数监控参数配置" id="lrmsMoni">
			...
			<r:col  field="hostName" title="主机名称" editable="true" sortable="true" width="150">
			</r:col>
			<r:col  field="localIp" title="主机IP" editable="true" sortable="true" width="150">
			</r:col>
			<r:col  field="serverName" title="服务名称" editable="true" sortable="true" width="150">
			</r:col>
			<r:col  field="userName" title="应用服务用户" editable="true" sortable="true" width="150">
			</r:col>
			<r:col  field="maxCourseNum" title="应用服务数" sortable="true" width="100" editable="true">
			...
			<r:col  field="col1" title="应用服务密码" sortable="true" width="100">
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="col2" title="应用服务进程命令" sortable="true" width="100">
			<r:editorText></r:editorText>
			</r:col>
				...
				if(selected.length>1){
					...
					var col3 = selected[0].col3;
							...
							$.ajax({
								...
								type: 'post',
								dataType : "Json",
								data:{uuid:uuid,hostName:hostName,localIp:localIp,serverName:serverName,
									maxCourseNum:maxCourseNum,userName:userName,
									warningLevl:warningLevl,remark:remark,col1:col1,col2:col2,col3:col3},
								url: "applyprosoftConfig_save.action",
								error:function(data){
	...
	function remove(){
		...
		if(selected.length== 0) {
			...
			$.ajax({
				...
				type: 'post',
				dataType : "Json",
				url: "${pageContext.request.contextPath}/applyprosoftConfig_remove.action?uuid="+uuids,
				success:function(data){
