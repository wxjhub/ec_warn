...
<body>
	<form name="formSearch" id="formSearch" method="post" style="padding: 20px 0 20px 30px;">
		...
		rownumbers="false" singleSelect="false" editable="true" url="transactionSuccess_findTransactionEndList.action" 
		striped="true" fit="true" height="50%"  title="长时间无交易监控" id="lrmsMoni">
			
			<%-- <r:col field="sysCode" title="平台名称" editable="false" sortable="true" width="150" dictId="sourseSys">
				<r:editorDictSelect missingMessage="不能为空" required="true"> </r:editorDictSelect>
			</r:col> --%>
			<r:col  field="transactionCode" title="末笔交易码" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="transactionName" title="末笔交易名称" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="seqNo" title="流水号" editable="false" sortable="true" width="150">
			</r:col>
			<r:col  field="startDate" title="末笔交易时间" sortable="true" width="150" editable="false">
			<r:editorText></r:editorText>
			</r:col>
			<r:col  field="noTransaction" title="无交易时长(s)" editable="false" sortable="true" width="100">
			</r:col>
