...
<div class="table_tt" style="margin-top: 30px;"><font class="blue">操作日志历史数据</font></div>
					...
					<table cellSpacing="0" cellpadding="0" border="0">
						...
						<tr>
							...
							<td width="260px" height="60px" colspan="3">
								<textarea rows="3" cols="62" style="border: 1px solid #ccc;" readonly="readonly">${operationLog.logData}</textarea>
							</td>  
						</tr>
						<tr>
